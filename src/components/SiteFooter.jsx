...
const SiteFooter = ({ isDark, onNavigate }) => {
  const footerClass = isDark
    ...
    : "border-slate-500/40 bg-slate-300/88 text-slate-900 shadow-[0_-24px_72px_rgba(15,23,42,0.14)]";
  ...
  const topGlowClass = isDark ? "bg-cyan-300/10" : "bg-cyan-300/10";
  const bottomGlowClass = isDark ? "bg-amber-300/5" : "bg-amber-300/8";
